        ...
        switch (args[0]) {
            ...
            case "claim":
                ...
                try {
                    ...
                    reportObject.setAdmin(p.getUniqueId().toString(),p);
            ...
            case "accept":
                ...
                try {
                    ...
                    reportObject.setReportStatus(ReportObject.ReportStatus.Accepted,p);
            ...
            case "deny":
                ...
                try {
                    ...
                    reportObject.setReportStatus(ReportObject.ReportStatus.Denided,p);
